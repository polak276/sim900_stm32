...
//=============================================================================
//#include "stm32f10x.h" tu zmienilem na swoj procek
#include "stm32f30x.h"
//=============================================================================
// Configuration
//=============================================================================
...
//niewiadomo dlaczego na tych pinach procek nie wystawia poprawnych stanow logicznych
#define SSD1963_PIN_RD	(1 << 4) //(1 << 0)
#define SSD1963_PIN_WR	(1 << 5) //(1 << 1)
#define SSD1963_PIN_CS	(1 << 6) //(1 << 2)
#define SSD1963_PIN_A0	(1 << 7) //(1 << 3)
#define SSD1963_PIN_RST (1 << 8)	//(1 << 4)

//mojde podswietlenie
#define SSD1963_PIN_BL_E	(1 << 9) //(1 << 5)
...
#define TFT_FPS 60ULL
	...
	#define TFT_WIDTH		480UL
	//nie wiem czy te parametry beda dobre
	#define TFT_HSYNC_BACK_PORCH	56ULL
	#define TFT_HSYNC_FRONT_PORCH	8ULL
	#define TFT_HSYNC_PULSE			96ULL
	
	#define TFT_HEIGHT		272UL
	//nie wiem czy te parametry beda dobre
	#define TFT_VSYNC_BACK_PORCH	41ULL
	#define TFT_VSYNC_FRONT_PORCH	2ULL
	#define TFT_VSYNC_PULSE			2ULL
